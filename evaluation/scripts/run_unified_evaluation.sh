...
PHOTOGRAPHER_PROMPT="${PHOTOGRAPHER_PROMPT:-请找出图片中构图最好的区域。按照(x1,y1),(x2,y2)的格式返回一个boudning box，其中(x1,y1)是左上角的顶点，(x2,y2)是右下角的顶点。}"
...
SUBJECT_PROMPT="${SUBJECT_PROMPT:-请推荐一个适合女生的姿势。}"
